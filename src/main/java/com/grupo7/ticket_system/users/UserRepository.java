...
public class UserRepository {
    ...
    public User saveUser(User user){
        ...
        //save user
        String sqltosaveuser= "INSERT INTO usuario (username,contraseña,rol,mail,pais_documento,tipo_documento,numero_documento,calle_direccion,numero_direccion, id_codigo_postal) VALUES (?,?,?,?,?,?,?)";
    ...
    public UserDetails getUserByUsername(String username){
        String sqltogetuserbyusername= "SELECT nombre_usuario, contraseña, rol FROM usuario WHERE nombre_usuario= ?";
        return template.queryForObject(sqltogetuserbyusername, UserDetails.class,username);
    }
}